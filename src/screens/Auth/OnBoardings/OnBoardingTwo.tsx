...
import { ONEBOARDINGOTHREE } from '../../../navigators/Stack';
        ...
        <View style={styles.container}>
            <View style={styles.inContainer}>
                ...
                <View style={styles.titleContainer}>
                    <CText style={styles.title}>{t('onboarding2_title')}</CText>
                    <CText>{t('onboarding2_description')}</CText>
                </View>

                <View style={{ flex: 1, justifyContent: "center" }}>
                    <View style={styles.contentPhotoContainer}>
                        <CImage
                            imgSource={isTablet ? images.onBoardingTwoTablet : images.onBoardingTwo}
                ...
                <View style={styles.btnContainer}>
                    ...
                    <TouchableOpacity style={styles.nextBtn} onPress={() => navigation.navigate(ONEBOARDINGOTHREE)}>
